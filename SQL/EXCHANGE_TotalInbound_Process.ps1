# Description: This script reads the log file and calculates the total inbound messages from Meditech and Cito Database. It also calculates the discrepancy between the two and the conversion errors.
try {
    Clear-Host
