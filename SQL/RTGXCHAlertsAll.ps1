# Description: This script reads the RTGXCHAlertsAll.log file and extracts the file name and processor name. It then searches the archive location for the file and outputs the results to a file.
